...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		new Music(album: album, date: new Date('2013/01/01'), time: 100.0, name: 'A').save(failOnError: true)
		new Music(album: album, date: new Date('2013/01/02'), time:  20.0, name: 'B').save(failOnError: true)
		new Music(album: album, date: new Date('2013/01/03'), time:   3.0, name: 'C').save(failOnError: true)
